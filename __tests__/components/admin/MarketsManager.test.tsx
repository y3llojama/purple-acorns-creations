...
describe('MarketsManager', () => {
  ...
  it('renders Craft Fairs tab by default', () => {
    render(<MarketsManager initialFairs={[sampleFair]} initialVenues={[sampleVenue]} />)
  ...
  it('search filters the active tab', () => {
    const secondFair: CraftFair = { ...sampleFair, id: '3', name: 'Winter Bazaar', location: 'Cambridge, MA' }
    render(<MarketsManager initialFairs={[sampleFair, secondFair]} initialVenues={[]} />)
  ...
  it('+ Add New button shows the form', () => {
    render(<MarketsManager initialFairs={[]} initialVenues={[]} />)
